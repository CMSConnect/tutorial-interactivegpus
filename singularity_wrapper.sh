...
if [ "x$OSG_SINGULARITY_REEXEC" = "x" ]; then
    ...
    unset OSG_SINGULARITY_AUTOLOAD
    ...
    if [ "x$OSG_SINGULARITY_IMAGE" = "x/cvmfs/singularity.opensciencegrid.org/bbockelm/cms:rhel6" -a -e "/cvmfs/oasis.opensciencegrid.org/osg-software/osg-wn-client/3.4/current/el6-x86_64/setup.sh" ]; then
        source /cvmfs/oasis.opensciencegrid.org/osg-software/osg-wn-client/3.4/current/el6-x86_64/setup.sh
    elif [ "x$OSG_SINGULARITY_IMAGE" = "x/cvmfs/singularity.opensciencegrid.org/bbockelm/cms:rhel7" -a -e "/cvmfs/oasis.opensciencegrid.org/osg-software/osg-wn-client/3.4/current/el7-x86_64/setup.sh" ]; then
